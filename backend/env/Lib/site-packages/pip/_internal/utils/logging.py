...
def setup_logging(verbosity, no_color, user_log_file):
    ...
    handler_classes = {
        "stream": "pip._internal.libs.logging.ColorizedStreamHandler",
        "file": "pip._internal.libs.logging.BetterRotatingFileHandler",
    }
    ...
    logging.config.dictConfig({
        ...
        "filters": {
            "exclude_warnings": {
                "()": "pip._internal.libs.logging.MaxLevelFilter",
            ...
            "exclude_subprocess": {
                "()": "pip._internal.libs.logging.ExcludeLoggerFilter",
                "name": subprocess_logger.name,
            },
        },
        "formatters": {
